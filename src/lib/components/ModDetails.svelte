...
<div
  class="border-primary-600 bg-primary-700 relative flex w-[40%] min-w-72 flex-col border px-6 pt-6 pb-4 text-white"
>
  <div class="pb-2 overflow-x-hidden overflow-y-auto light-scrollbar">
    <div>
      <a
...
<DependenciesDialog title={mod.displayTitle} bind:open={dependenciesOpen}>
  {#if mod.dependencies}
    <ModCardList ids={mod.dependencies} class="mt-4" />
  {/if}
</DependenciesDialog>
